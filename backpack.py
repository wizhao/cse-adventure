...
class Backpack(object):
    ...
    def __init__(self):
        ...
        grenade = Item('Grenades', 'Kablam!', 'tool',"grenades.png")
        ...
        yellow_crystal = Item('Yellow Crystal', 'Powers your portal gun. From the Post Apocalyptic World' , 'crystal')
        blue_crystal = Item('Blue Crystal', 'Powers your portal gun. From Atlantis.', 'crystal')
        green_crystal = Item('Green Crystal', 'Powers your portal gun. From the Dino World.', 'crystal')
        red_crystal = Item('Red Crystal', 'Powers your portal gun. From the War World', 'crystal')
        purple_crystal = Item('Purple Crystal', 'Powers your portal gun. From Ice World', 'crystal')
        orange_crystal = Item('Orange Crystal', 'Powers your portal gun. From the future.', 'crystal')
